...
"""Default configurations for axiomcuda experiments."""
...
from axiomcuda.models import smm, tmm, rmm, imm
...
class ExperimentConfig:
    """Configuration for axiomcuda experiments.
    ...
    Attributes:
        ...
        perturb: Environment perturbation type
...
def parse_floats(s):
    """Parse comma-separated float string into list of floats.
    
    Args:
        s: Comma-separated float string
...
def expand_used_threshold(values: Sequence[float], n_layers: int) -> list[float]:
    """Expand used threshold values for multiple layers.
    ...
    Args:
        values: Input threshold values
        n_layers: Number of SMM layers
...
def expand_layer_values(
    ...
    """Expand layer-wise values to match number of layers.
...
def create_smm_configs(args):
    ...
    Returns:
        Tuple of SMMConfig objects, one per layer
    """
...
def get_defaults(parser):
    """Add default arguments to argument parser.
    ...
    """
    parser.add_argument("--name", type=str, default="axiomcuda")
    parser.add_argument("--uid", type=str, default=None)
    parser.add_argument("--group", type=str, default="axiomcuda")
...
def from_dict(data_clazz, d):
    ...
    Args:
        data_clazz: Dataclass type to convert to
        d: Dictionary with data
...
def load_config(config_path, seed=0):
    """Load configuration from YAML file with seed override.
...
def parse_args(args=None):
    ...
    This is the main entry point for configuration. It parses command-line
    arguments and creates a complete ExperimentConfig with all model configs.
